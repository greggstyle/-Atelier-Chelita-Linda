...
ateliers_attributes = [
  {
    ...
    description:  'Durante este taller, nuestro Beer Sommelier les estará dando una introducción al mundo de la cerveza. El beer sommelier es a la cerveza lo que el enólogo es para el vino. Porque si, la cerveza se observa, se huele, se saborea, y se vuelve a saborear.
